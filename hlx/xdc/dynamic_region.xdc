...
create_clock -period 4.000 -name CLK_IN_250M [get_ports CLK_IN_250M]
create_clock -period 50.000 -name S_BSCAN_tck [get_ports S_BSCAN_tck]
create_clock -period 4.000 -name CLK_IN_PROG [get_ports CLK_IN_PROG]
create_clock -period 3.333 -name CLK_IN_300M [get_ports CLK_IN_300M]
create_clock -period 2.500 -name CLK_IN_400M [get_ports CLK_IN_400M]
